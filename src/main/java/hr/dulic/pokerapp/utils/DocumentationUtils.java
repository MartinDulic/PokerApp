...
public final class DocumentationUtils {
    ...
    public static void readClassInfo(Class<?> clazz, StringBuilder classInfo) {
        appendDivStart(classInfo);
        appendPackage(clazz, classInfo);
        appendDivEnd(classInfo);
        appendH2Start(classInfo);
        ...
        appendH2End(classInfo);
    }

    private static void appendH2End(StringBuilder classInfo) {
        classInfo.append("</h2>");
    }

    private static void appendH2Start(StringBuilder classInfo) {
        classInfo.append("<h2>");
    }

    private static void appendDivEnd(StringBuilder classInfo) {
        classInfo.append("</div>");
    }

    private static void appendDivStart(StringBuilder classInfo) {
    }
    ...
    private static void appendBr(StringBuilder classAndMembersInfo) {
